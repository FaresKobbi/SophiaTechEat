 ...
 * 
 * when(mockBankInfo.getExpirationDate()).thenReturn(YearMonth.from(LocalDate.
 * now().plusYears(2)));
 ...
 * orderManager.createOrder(mockDishes, "student123", mockDeliveryLocation,
 * "rest123");
 * 
 ...
 * 
 * manager.createOrder(mockDishes, "student123", mockDeliveryLocation,
 * "rest123");
 * 
 ...
 * 
 * @Test
 * void initiatePaymentUsesFactoryAndUpdatesOrderStatus() throws
 ...
 * Order order = managerWithFactory.createOrder(mockDishes, "student123",
 * mockDeliveryLocation, "rest123");
 * 
 * IPaymentProcessor processor = mock(IPaymentProcessor.class);
 * when(factory.createProcessor(order,
 * PaymentMethod.EXTERNAL)).thenReturn(processor);
 ...
 * Order order = orderManager.createOrder(mockDishes, "student123",
 * mockDeliveryLocation, "rest123");
 * 
