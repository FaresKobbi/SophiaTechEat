        ...
        public static void main(String[] args) throws IOException {
                ...
                accountManager.addAccount(
                                new StudentAccount.Builder("Alice", "Smith")
                                                ...
                                                .addDeliveryLocation(new DeliveryLocation("Home", "10 Rue de France",
                                                                "Nice", "06000"))
                                                .addDeliveryLocation(new DeliveryLocation("University",
                                                                "930 Route des Colles", "Biot", "06410"))
                                                .build());
                accountManager.addAccount(
                                new StudentAccount.Builder("Bob", "Martin")
                                                .deliveryLocations(List.of(
                                                                new DeliveryLocation("Home", "123 Main St", "Nice",
                                                                                "06000"),
                                                                new DeliveryLocation("Work", "456 Elm St", "Nice",
                                                                                "06000")))
                                                .bankInfo("1234567890123456", 123, 12, 2026)
                                                .email("bob.martin@etu.unice.fr")
                                                .addDeliveryLocation(new DeliveryLocation("Dorm",
                                                                "50 Avenue Jean Medecin", "Nice", "06000"))
