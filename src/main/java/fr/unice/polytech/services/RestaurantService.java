...
public class RestaurantService {
    ...
    private static void populateMockData() {
        ...
        addDishToRestaurant(japanese, "Salmon Sashimi", "Fresh raw salmon slices", 16.00,
                DishType.SUSHI, DishCategory.MAIN_COURSE, List.of(DietaryLabel.GLUTEN_FREE, DietaryLabel.HALAL));

        addDishToRestaurant(japanese, "Veggie Ramen", "Noodle soup with tofu and vegetables", 13.50,
                DishType.GENERAL, DishCategory.MAIN_COURSE, List.of(DietaryLabel.VEGAN, DietaryLabel.VEGETARIAN));

        addDishToRestaurant(japanese, "Mochi Ice Cream", "Rice cake with ice cream filling", 5.50,
                DishType.ICE_CREAM, DishCategory.DESSERT, List.of(DietaryLabel.VEGETARIAN, DietaryLabel.GLUTEN_FREE));
        ...
        addDishToRestaurant(american, "Coca Cola", "Chilled soda 33cl", 3.00,
                DishType.DRINK, DishCategory.DRINK, List.of(DietaryLabel.VEGAN, DietaryLabel.VEGETARIAN, DietaryLabel.GLUTEN_FREE));
        ...
        addDishToRestaurant(french, "Ratatouille", "Stewed vegetables (Tomato, Eggplant, Zucchini)", 14.00,
                DishType.GENERAL, DishCategory.MAIN_COURSE, List.of(DietaryLabel.VEGAN, DietaryLabel.VEGETARIAN, DietaryLabel.GLUTEN_FREE));
        ...
        addDishToRestaurant(indian, "Chicken Tikka Masala", "Roasted marinated chicken in spiced curry", 16.50,
                DishType.MEAT, DishCategory.MAIN_COURSE, List.of(DietaryLabel.HALAL, DietaryLabel.GLUTEN_FREE));

        addDishToRestaurant(indian, "Palak Paneer", "Cottage cheese in spinach gravy", 13.00,
                DishType.GENERAL, DishCategory.MAIN_COURSE, List.of(DietaryLabel.VEGETARIAN, DietaryLabel.GLUTEN_FREE));
